...
Page({
    ...
    getGoodsList(){
        ...
        fetchApi(this, params).then(res => {
          this.data.goodList = res.data.data.info
          this.setData({
    ...
    setList(){
        ...
        let params = {
            ...
            data: {
                home_goods:JSON.stringify(list)
            }
        }
        fetchApi(this, params).then(res => {
    ...
    delList(e){
        ...
        wx.showModal({
            ...
            success: (res) => {
                if (res.confirm) {
                    let params = {
                        url: app.API_HOST + "card/delHomeGoods",
                        data: {
                            goodsId: id
                        }
                    }
    ...
    addList(){
        nav({
            url:'/centerControl/chooseRecommendedService/chooseRecommendedService',
            data:{}
        })
    }
})