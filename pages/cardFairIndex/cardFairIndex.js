...
Page({
    ...
    onLoad (options) {
        if (options.cardId) {
            ...
            if (app.tabBarPath.indexOf("/pages/cardFairIndex/cardFairIndex") == -1) {
                this.setData({
                    isFromShare: true
                });
            }
     ...
     */
    onShareAppMessage() {
        console.log(`/pages/cardFairIndex/cardFairIndex?cardId=${app.globalData.cardId}&fromUser=${app.globalData.uid}`,22)
        return {
            path: `/pages/cardFairIndex/cardFairIndex?cardId=${app.globalData.cardId}&fromUser=${app.globalData.uid}`,
        }
    }
})